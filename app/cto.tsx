        ...
        <>
            <div className="max-w-full md:columns-3 gap-0 bg-card drop-shadow-sm">
                ...
                <div className='h-40 md:h-48 shadow flex flex-col items-center justify-center'>
                    ...
                    <button onClick={() => setOpen(true)} className="rounded-none bg-red-700 flex w-60 lg:w-80 h-14 md:h-20  p-8 md:p-8 flex items-center shadow-md space-x-4 md:space-x-0 flex justify-center md:jusitfy-start">
