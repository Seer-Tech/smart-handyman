        ...
        <>
            <div className="mx-auto mx-w-full bg-header pb-10 md:pb-0">
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 bg-header md:columns-2 sm:flex items-center text-center sm:text-start"> 
                    ...
                    <p className="font-ox text-white font-medium text-5xl md:text-7xl xl:text-8xl">Handyman Services</p>
                    <p className="font-ra text-white text-md md:text-xl">We are a team of experienced handymen ready to deliver exceptional service across the board.</p>
                    ...
                    <button onClick={() => setOpen(true)} className="transition-all ease-in-out duration-500 rounded-none bg-red-700 hover:bg-red-800 h-10 md:h-12 flex items-center p-2 md:p-5 space-x-1 md:space-x-2.5 shrink">
                        <p className="font-ra text-white font-bold text-sm md:text-md">SCHEDULE YOUR APPOINTMENT</p>
